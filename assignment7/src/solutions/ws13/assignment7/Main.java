...
public class Main extends Amcgala implements InputHandler {
    ...
    private IsoCam isoCam = new IsoCam(Vector3d.UNIT_Y, position, direction);
    ...
    public static boolean manyBoxes = true;
    ...
    public Main() {
    	if(manyBoxes){
    		...
    		scene.addShape(new Box(new Vertex3f(-100, 0, -5), 40, 40, 40));
    	}
